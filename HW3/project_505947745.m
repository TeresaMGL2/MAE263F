%% (Junlin Chen, 505947745, project_505947745.m, main file borrowed from Bruinlearn and modified for needs)
%% Main File
...
for i = 1:epochs
    ...
    fprintf('Cross entropy loss after epoch %d training is: %f\n', i, norm(cost));
